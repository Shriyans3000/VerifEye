        ...
        <div className="flex items-center space-x-2 w-full md:w-auto">
          {selectedRepo && (
            <button
              type="button"
              onClick={() => setSelectedRepo(null)}
              className="inline-flex items-center px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded text-xs font-bold border border-slate-300 transition cursor-pointer"
            >
          ...
          <button
            ...
            className="p-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded border border-slate-300 transition cursor-pointer"
              ...
              {filteredRepositories.map((repo) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white border border-slate-300 hover:border-amber-500 rounded-lg p-5 shadow-xs hover:shadow-md transition cursor-pointer flex flex-col justify-between space-y-4 group"
                  >
                    <div>
                      {/* Top Brand Tag & Status */}
                      <div className="flex justify-between items-start gap-2 mb-2">
                        <span className="px-2.5 py-0.5 bg-slate-900 text-amber-400 font-mono text-[11px] font-bold rounded uppercase tracking-wider">
                          {repo.category}
                        </span>
                        <span className="text-[11px] font-bold text-slate-500 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded">
                          {repo.monitoring_status || 'Surveillance'}
                        </span>
                      </div>

                      {/* Brand Title */}
                      <h3 className="text-lg font-black text-slate-900 group-hover:text-amber-600 transition flex items-center justify-between">
